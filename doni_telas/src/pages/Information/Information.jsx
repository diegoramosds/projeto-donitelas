    ...
    <div className='main-info'>
      ...
      <div className='questions-info'>
        ...
        <div className="ansewrs">
            <h4>Quanto é cobrado no orçamento?</h4>
            <p> O orçamento é totalmente  gratuito  e sem compromisso. Meu objetivo é que você
              tenha clareza sobre o que será feito e
              quanto vai investir, permitindo que tome uma decisão  informada   e
              segura.</p>
          </div>

          <div className="ansewrs">
            <h4>Qual valor cobrado nos serviços?</h4>
